...
"use strict";
/* unused harmony export WorkspaceUser */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Checks; });
/* unused harmony export Creation */
/* unused harmony export CreationAlert */
/* unused harmony export CurrentWorkspace */
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return LabarchivesLinkField; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return LabarchivesLinkComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_forms__ = __webpack_require__("./node_modules/@angular/forms/esm5/forms.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__helpers__ = __webpack_require__("./src/app/components/helpers.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__labarchives_service__ = __webpack_require__("./src/app/labarchives.service.ts");
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var LabarchivesLinkField = /** @class */ (function (_super) {
    ...
    function LabarchivesLinkField(options, injector) {
        var _this = _super.call(this, options, injector) || this;
        _this.LinkItem = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
        _this.labarchivesService = _this.getFromInjector(__WEBPACK_IMPORTED_MODULE_5__labarchives_service__["a" /* LabarchivesService */]);
        ...
        _this.checks = new __WEBPACK_IMPORTED_MODULE_4__helpers__["a" /* Checks */]();
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return LabarchivesListField; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return LabarchivesListComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__shared_form_field_simple_component__ = __webpack_require__("./redbox-portal/angular/shared/form/field-simple.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_form_field_base__ = __webpack_require__("./redbox-portal/angular/shared/form/field-base.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__labarchives_service__ = __webpack_require__("./src/app/labarchives.service.ts");
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var LabarchivesListField = /** @class */ (function (_super) {
    ...
    function LabarchivesListField(options, injector) {
        ...
        _this.failedObjects = [];
        _this.labUser = {};
        _this.link = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
        _this.checkLoggedIn = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
        _this.labarchivesService = _this.getFromInjector(__WEBPACK_IMPORTED_MODULE_3__labarchives_service__["a" /* LabarchivesService */]);
        _this.columns = [
    ...
    LabarchivesListField.prototype.bindUser = function (labUser) {
        console.log(labUser);
    ...
    LabarchivesListField.prototype.listWorkspaces = function () {
        var _this = this;
        this.labarchivesService.list().then(function (response) {
            _this.loggedIn = _this.fieldMap._rootComp.loggedIn = true;
            _this.checkLoggedIn.emit(true);
            _this.workspaces = response.map(function (nb) {
    ...
    LabarchivesListField.prototype.checkLinks = function () {
        ...
        this.workspaces.map(function (w, index) {
            _this.labarchivesService.checkLink(_this.rdmp, w['id'])
                .then(function (response) {
                if (!response.status) {
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return LabarchivesLoginField; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return LabarchivesLoginComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__shared_form_field_simple_component__ = __webpack_require__("./redbox-portal/angular/shared/form/field-simple.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_form_field_base__ = __webpack_require__("./redbox-portal/angular/shared/form/field-base.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__labarchives_service__ = __webpack_require__("./src/app/labarchives.service.ts");
...
var LabarchivesLoginField = /** @class */ (function (_super) {
    ...
    function LabarchivesLoginField(options, injector) {
        ...
        _this.userLogin = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return LabarchivesFormComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_labarchives_login_component__ = __webpack_require__("./src/app/components/labarchives-login.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_labarchives_list_component__ = __webpack_require__("./src/app/components/labarchives-list.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_labarchives_link_component__ = __webpack_require__("./src/app/components/labarchives-link.component.ts");
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var LabarchivesFormComponent = /** @class */ (function (_super) {
    ...
    LabarchivesFormComponent.prototype.loadForm = function () {
        ...
        this.fcs.addComponentClasses({
            'LabarchivesLoginField': { 'meta': __WEBPACK_IMPORTED_MODULE_6__components_labarchives_login_component__["b" /* LabarchivesLoginField */], 'comp': __WEBPACK_IMPORTED_MODULE_6__components_labarchives_login_component__["a" /* LabarchivesLoginComponent */] },
            'LabarchivesListField': { 'meta': __WEBPACK_IMPORTED_MODULE_7__components_labarchives_list_component__["b" /* LabarchivesListField */], 'comp': __WEBPACK_IMPORTED_MODULE_7__components_labarchives_list_component__["a" /* LabarchivesListComponent */] },
            'LabarchivesLinkField': { 'meta': __WEBPACK_IMPORTED_MODULE_8__components_labarchives_link_component__["b" /* LabarchivesLinkField */], 'comp': __WEBPACK_IMPORTED_MODULE_8__components_labarchives_link_component__["a" /* LabarchivesLinkComponent */] }
        });
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return LabarchivesModule; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__labarchives_service__ = __webpack_require__("./src/app/labarchives.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__labarchives_form_component__ = __webpack_require__("./src/app/labarchives-form.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_labarchives_login_component__ = __webpack_require__("./src/app/components/labarchives-login.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_labarchives_list_component__ = __webpack_require__("./src/app/components/labarchives-list.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_labarchives_link_component__ = __webpack_require__("./src/app/components/labarchives-link.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
...
var LabarchivesModule = /** @class */ (function () {
    ...
    LabarchivesModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["NgModule"])({
            imports: [
                __WEBPACK_IMPORTED_MODULE_0__angular_platform_browser__["a" /* BrowserModule */], __WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* ReactiveFormsModule */], __WEBPACK_IMPORTED_MODULE_1__angular_forms__["d" /* FormsModule */], __WEBPACK_IMPORTED_MODULE_3__shared_shared_module__["a" /* SharedModule */]
            ],
            declarations: [
                __WEBPACK_IMPORTED_MODULE_5__labarchives_form_component__["a" /* LabarchivesFormComponent */], __WEBPACK_IMPORTED_MODULE_6__components_labarchives_login_component__["a" /* LabarchivesLoginComponent */], __WEBPACK_IMPORTED_MODULE_7__components_labarchives_list_component__["a" /* LabarchivesListComponent */], __WEBPACK_IMPORTED_MODULE_8__components_labarchives_link_component__["a" /* LabarchivesLinkComponent */]
            ],
            exports: [],
            providers: [
                __WEBPACK_IMPORTED_MODULE_4__labarchives_service__["a" /* LabarchivesService */]
            ],
            bootstrap: [
                __WEBPACK_IMPORTED_MODULE_5__labarchives_form_component__["a" /* LabarchivesFormComponent */]
            ],
            entryComponents: [
                __WEBPACK_IMPORTED_MODULE_5__labarchives_form_component__["a" /* LabarchivesFormComponent */], __WEBPACK_IMPORTED_MODULE_7__components_labarchives_list_component__["a" /* LabarchivesListComponent */], __WEBPACK_IMPORTED_MODULE_6__components_labarchives_login_component__["a" /* LabarchivesLoginComponent */], __WEBPACK_IMPORTED_MODULE_8__components_labarchives_link_component__["a" /* LabarchivesLinkComponent */]
            ]
        })
    ], LabarchivesModule);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return LabarchivesService; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__app_labarchives_module__ = __webpack_require__("./src/app/labarchives.module.ts");
...
Object(__WEBPACK_IMPORTED_MODULE_1__angular_platform_browser_dynamic__["a" /* platformBrowserDynamic */])().bootstrapModule(__WEBPACK_IMPORTED_MODULE_2__app_labarchives_module__["a" /* LabarchivesModule */])
