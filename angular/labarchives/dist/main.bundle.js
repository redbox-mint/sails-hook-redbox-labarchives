...
var DashboardService = /** @class */ (function (_super) {
    ...
    DashboardService.prototype.getAllRecordsCanEdit = function (recordType, state) {
        ...
        var rows = this.config.maxTransferRowsPerPage;
        var start = 0;
        var url = this.brandingAndPortalUrl + "/listRecords?recordType=" + recordType + "&editOnly=true&start=" + start + "&rows=" + rows + "&ts=" + moment_es6_1.default().unix();
        if (state != '') {
            url += "&state=" + state;
        }
            ...
            allAttachmentsPromise.then(function (allAttachments) {
                ...
                _.forEach(allAttachments, function (attachment) {
                    if (matchingExpression_1.test(attachment.label)) {
                        ...
                        if (_this.field.latestPdf == null || moment_es6_1.default(_this.field.latestPdf['dateUpdated']).isBefore(moment_es6_1.default(attachment.dateUpdated))) {
                            _this.field.latestPdf = attachment;
                        }
                    }
                });
                _this.field.pdfAttachments.sort(function compare(a, b) {
                    var before = moment_es6_1.default(a['dateUpdated']).isBefore(moment_es6_1.default(b['dateUpdated']));
...
var UtilityService = /** @class */ (function () {
    ...
    UtilityService.prototype.runTemplate = function (data, config) {
        var imports = _.extend({ data: data, config: config, moment: moment_es6_1.default }, this);
